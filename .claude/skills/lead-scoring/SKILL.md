...
| 評価項目 | 詳細 | 点数 |
|---|---|---|
| 反応温度: 前のめり | 積極的に質問・メモを取る | +40 |
| 反応温度: 普通 | 話は聞くが質問なし | +20 |
| 反応温度: 薄い | 明らかに興味なし | +5 |
| 反応温度: 未接触 | | +0 |
| メールアドレス取得 | 連絡可能な状態になった（CRMのcontactEmail列が非空） | +20 |
| 企業規模 6〜20名 | AI化メリット大 | +15 |
| 企業規模 21〜50名 | 予算あり | +20 |
...
| シグナル | 加算点 |
|---|---|
| 具体的な記載あり（「〇〇業務を自動化したい」など） | +40 |
| 電話希望にチェック | +30 |
| 資料DL後に送信（検討成熟度が高い） | +35 |
| 企業名・実名記載 | +20 |
| 予算・規模に言及 | +20 |
